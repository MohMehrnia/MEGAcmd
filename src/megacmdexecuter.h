...
public:
    ...
    void uploadNode(const std::map<std::string, int> &clflags, const std::map<std::string, std::string> &cloptions, std::string localPath, mega::MegaApi* api, mega::MegaNode *node, std::string newname, MegaCmdMultiTransferListener *multiTransferListener = NULL);
